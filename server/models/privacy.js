                ...
                if(type == "videos"){
                    ...
                    if(req.appSettings['whitelist_domain'] == 1){
                            ...
                            if(req.user){
                                ...
                                let userIP = typeof req.headers != "undefined" && req.headers['x-real-ip'] ? req.headers['x-real-ip'] : (req.connection && req.connection.remoteAddress ? req.connection.remoteAddress : "");
                    ...
                    sql += ' WHEN view_privacy = "follow" THEN (SELECT id FROM followers WHERE type = "members" AND owner_id = movies.owner_id && id = '+owner_id+' )  '
            ...
            req.getConnection(async function(err,connection){
                ...
                */
                ...
                if(obj.view_privacy == "onlyme"){
                    ...
                    }else if(obj.movie_id){
                        if(req.session.password.indexOf(obj.movie_id) > -1){
                            resolve(true)
                            return
                        }
