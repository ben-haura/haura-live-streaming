...
const Extended = withTranslation('common', {  wait: typeof window !== 'undefined' })(Category);
...
Extended.getInitialProps = async function(context) {
    ...
    if(isServer){
      ...
      const pageData = await axios.get("/"+context.query.type+"/category/"+context.query.id+"?data=1");
