                    ...
                    : props.maintanance ?
                        ...
                        <React.Fragment>
                                <div className="titleBarTop">
                                    <div className="titleBarTopBg"><img src={props.pageData['pageInfo']['banner'] ? props.pageData.imageSuffix+props.pageData['pageInfo']['banner'] : props.pageData['subFolder']+"static/images/breadcumb-bg.jpg"}
...
const Extended = withTranslation('common', { wait: typeof window !== 'undefined' })(VerifyAccount);
