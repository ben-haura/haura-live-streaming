...
const Extended = withTranslation('common', { wait: typeof window !== 'undefined' })(Season);
...
Extended.getInitialProps = async function(context) {
    ...
    if(isServer){
      ...
      const pageData = await axios.get(`/watch/${context.query.id}/season/${context.query.season_id}?data=1`);
