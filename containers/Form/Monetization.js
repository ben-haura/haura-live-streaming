...
class Monetization extends Component {
    ...
    render() {
        ...
        let formFields = []
        let perclick = {}
        perclick['package'] = { price: this.props.pageData.appSettings['ads_cost_publisher'] }        
        ...
        formFields.push({
          ...
          },
          {
            key: "res_type_1",
            type: "content",
            content: '<h6 className="custom-control">' + this.props.t("Earn {{data}} for each advertisement click you get from your videos!",{data:"("+Currency({...this.props,...perclick}).replace("<!-- -->","")+")"}) + '</h6>'
        });
