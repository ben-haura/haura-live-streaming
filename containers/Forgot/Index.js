    ...
    onSubmit = (e) => {
        ...
        if(this.state.type == "email"){
            ...
            if(!this.state.phone_number){
                ...
                let checkError = false;//isValidPhoneNumber(this.state.phone_number) ? undefined : 'Invalid phone number';
                if(checkError){
                    valid = false;
                    emailError = Translate(this.props, "Enter valid Phone Number.")
                }
            ...
            <React.Fragment>
                {
                    ...
                    <div className="titleBarTop">
                        <div className="titleBarTopBg">
                            <img src={this.props.pageData['pageInfo']['banner'] ? this.props.pageData.imageSuffix+this.props.pageData['pageInfo']['banner'] : this.props.pageData['subFolder']+"static/images/breadcumb-bg.jpg"} alt={this.props.t("Forgot Password")} />
                        </div>
