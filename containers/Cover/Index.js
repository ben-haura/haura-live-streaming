...
class Cover extends Component {
    ...
    repositionSave = (e) => {
        ...
        url = `/channels/reposition-cover?containerHeight=${$(".header-info-wrap").height()}`;
        axios.post(url, formData, config)
            .then(response => {
    ...
    render() {
        ...
        return (
            <React.Fragment>
                <div className={`${this.props.pageData.themeType != 2 ? "header-info-wrap container" : "header-info-wrap subscription-urser"} `}>
                            ...
                            {/* <div className="box-overlay"></div> */}
                                {
                                        ...
                                        <React.Fragment>
                                            ...
                                            {
                                                this.state.repositionDisplay == "block" && this.state.item.channelcover && !gif ? 
                            ...
                            <div className="userInfo-block-wrap">
                                <div className="userInfo-block-content">
                                    <div className="userinfoLeft">
                                        ...
                                        <div className="user-profile-title">
                                            ...
                                            <div className="ChannelMoreinfo">
                                                {
                                                    this.props.pageData.appSettings['channel_featured'] == 1 && this.state.item.is_featured == 1 ?
                                                ...
                                                {
                                                    this.props.pageData.appSettings['channel_sponsored'] == 1 && this.state.item.is_sponsored == 1 ?
                                                ...
                                                {
                                                    this.props.pageData.appSettings['channel_hot'] == 1 && this.state.item.is_hot == 1 ?
                                       ...
                                       <div className="follow-cnt">
                                       {
                                        this.state.item.approve == 1 ? 
                                            <div className="channel_subscribe">
                                                {
                                                    this.props.pageData.appSettings['channel_support'] == 1 && parseFloat(this.state.item.channel_subscription_amount) > 0 ? 
                                    ...
                                    <ul className="LikeDislikeList">
                                        {
                                            this.props.pageData.appSettings[`${"channel_like"}`] == 1 && this.state.item.approve == 1 ?
                                                <li>
                                        ...
                                        {
                                            this.props.pageData.appSettings[`${"channel_dislike"}`] == 1 && this.state.item.approve == 1 ?
                                                <li>
                                        ...
                                        {
                                            this.props.pageData.appSettings[`${"channel_favourite"}`] == 1 && this.state.item.approve == 1 ?
                                                <li>
                                        ...
                                        {
                                            this.state.item.approve == 1 ?
                                                <SocialShare {...this.props} hideTitle={true} tags={this.state.item.tags} url={`${this.props.url}`} title={CensorWord("fn",this.props,this.state.item.title)} imageSuffix={this.props.pageData.imageSuffix} media={this.state.item.image} />
                                            : null
                                        }
                                        <li>
                                            <div className="dropdown TitleRightDropdown">
                                                    ...
                                                    
                                                {
                                                    this.state.item.canEdit ?
                                                    <li>
                                                        <Link href="/create-channel" customParam={`id=${this.state.item.custom_url}`} as={`/create-channel/${this.state.item.custom_url}`}>
                                                ...
                                                {
                                                    this.state.item.approve == 1 && !this.state.item.canEdit ? 
                                                <li>
...
export default connect(null, mapDispatchToProps, null)(Cover);