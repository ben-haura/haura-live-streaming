        ...
        let results = this.state.items.map(item => {
            ...
            return (
                <tr key={item.withdraw_id}>
                    ...
                    <td>
                        {
                            <span dangerouslySetInnerHTML={{__html:Date(this.props,item.creation_date,this.props.initialLanguage,'dddd, MMMM Do YYYY',this.props.pageData.defaultTimezone)}}></span>
                        }    
                    </td>
                    <td>
