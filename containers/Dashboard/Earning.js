        ...
        let results = this.state.items.map(item => {
            ...
            if(item.transType != "ads"){
                if(item.transType == "video_tip"){
                    ...
                    type = Translate(this.props,'Purchase Series');
                }else if(item.transType == "rent_movie_purchase"){
                    type = Translate(this.props,'Rent Movie');
                }else if(item.transType == "rent_series_purchase"){
                    type = Translate(this.props,'Rent Series');
                }else if(item.transType == "purchase_movie_purchase"){
                    type = Translate(this.props,'Purchase Movie');
                }else{
            ...
            return (
                <tr key={item.id+item.type}>
                    ...
                    <td>{Currency({...this.props,...netamount})}</td>
                    <td>{item.admin_commission ? Currency({...this.props,...commission}).replace("<!-- -->","") : "-"}</td>
                    <td>{Currency({...this.props,...amount}).replace("<!-- -->","")}</td>
