        ...
        if(!this.state.otpEnable){
            ...
            if(this.state.type == "email"){
                ...
                if(!this.state.phone_number){
                    ...
                    let checkError = false;//PhoneInput.isValidPhoneNumber(this.state.phone_number) ? undefined : 'Invalid phone number';
                    if(checkError){
                        valid = false
                        emailError = Translate(this.props, "Enter valid Phone Number.")
                    }
        ...
        return (
            <React.Fragment>
                ...
                <div className="forgot">
                    ...
                    <Link href="/forgot">
                        <a className="forgot-btn" onClick={this.forgot}>{Translate(this.props,"forgot password?")}</a>
                    </Link>
                </div>
            </React.Fragment>
        )
