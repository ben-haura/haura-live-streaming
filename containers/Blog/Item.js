            ...
            <React.Fragment>
                ...
                <div className="snglblog-block clearfix" key={this.state.blog.blog_id}>
                    <div className="blogImgWrap">
                        <Link href={`/blog`} customParam={`id=${this.state.blog.custom_url}`} as={`/blog/${this.state.blog.custom_url}`}>
                            <a className="blogImg"  onClick={this.props.closePopUp}>
                                <Image image={this.state.blog.image} title={<CensorWord {...this.props} text={this.state.blog.title} />} imageSuffix={this.props.pageData.imageSuffix} siteURL={this.props.pageData.siteURL} />
                        ...
                        <div className="lbletop">
                            ...
                            {
                                this.props.pageData.appSettings['blogs_browse_featuredlabel'] == 1 && this.props.pageData.appSettings['blog_featured'] == 1 && this.state.blog.is_featured == 1 ?
                            ...
                            {
                                this.props.pageData.appSettings['blogs_browse_sponsoredLabel'] == 1 && this.props.pageData.appSettings['blog_sponsored'] == 1 && this.state.blog.is_sponsored == 1 ?
                            ...
                            {
                                this.props.pageData.appSettings['blogs_browse_hotLabel'] == 1 && this.props.pageData.appSettings['blog_hot'] == 1 && this.state.blog.is_hot == 1 ?
                    ...
                    <div className={`blogContent${this.props.canDelete || this.props.canEdit  || this.props.pageData.appSettings["blogs_browse_share"] == 1 ? " edit-blog-btn" : ""}`}>                        
                        <Link href={`/blog`} customParam={`id=${this.state.blog.custom_url}`} as={`/blog/${this.state.blog.custom_url}`}>
                            <a className="blogTitle"  onClick={this.props.closePopUp}>{CensorWord("fn",this.props,this.state.blog.title)}</a>
                        </Link>
                        {
                                    this.props.canDelete || this.props.canEdit || this.props.pageData.appSettings["blogs_browse_share"] == 1 ? 
                                <div className="dropdown TitleRightDropdown">
                                    ...
                                    {
                                        this.props.pageData.appSettings['blogs_browse_share'] == 1 ?
                                            <SocialShare {...this.props} buttonHeightWidth="30" round="true" tags={this.state.blog.tags} url={`/blog/${this.state.blog.custom_url}`} title={CensorWord("fn",this.props,this.state.blog.title)} imageSuffix={this.props.pageData.imageSuffix} media={this.state.blog.image} />
                                            : null
                                    }
                                    </ul>
                                </div>
                    ...
                    {
                            this.props.pageData.appSettings['blogs_browse_username'] == 1 ?
                    ...
                    {
                                    this.props.pageData.appSettings["blogs_browse_views"] == 1 || this.props.pageData.appSettings["blogs_browse_datetime"] ? 
                            <span className="videoViewDate">
                                {
                                    this.props.pageData.appSettings["blogs_browse_views"] == 1  ? 
                                ...
                                : null
                                 ...
                                 {
                            this.props.pageData.appSettings["blogs_browse_views"] == "1" && this.props.pageData.appSettings["blogs_browse_datetime"] == "1" ?
                                <span className="seprater">|</span>
                            : null
                            }
                                {
                                    this.props.pageData.appSettings["blogs_browse_datetime"] == 1  ? 
                    ...
                    <div className="LikeDislikeWrap">
                        <ul className="LikeDislikeList">
                                ...
                                {
                                    this.props.pageData.appSettings['blogs_browse_like'] == 1 ?
                                        <li>
                                ...
                                {
                                    this.props.pageData.appSettings['blogs_browse_dislike'] == 1 ?
                                        <li>
                                ...
                                {
                                    this.props.pageData.appSettings['blogs_browse_favourite'] == 1 ?
                                        <li>
