...
class Form extends Component {
    ...
    phoneNumber = (value) => {
        ...
        }else if(this.props.pageData.appSettings["signup_phone_number_required"] == 1){
            this.setState({
                fields: updateObject(this.state.fields, {
                    ["phone_number"]: updateObject(this.state.fields["phone_number"], {
                        value: "",
    ...
    onSubmit = async (e) => {
        ...
        if(this.props.pageData.appSettings['twillio_enable'] == 1){
            if (!this.state.fields.phone_number.value && this.props.pageData.appSettings["signup_phone_number_required"] == 1) {
                isValid = false
                ...
                let checkError =false;// isValidPhoneNumber(this.state.fields.phone_number.value) ? undefined : 'Invalid phone number';
                if(checkError)
        ...
        if(this.props.pageData.appSettings["recaptcha_enable"] == 1 && this.props.pageData.appSettings["recaptcha_signup_enable"] == 1){
            let isSubmit = true;
            if(this.state.fields.phone_number.value && this.props.pageData.appSettings['twillio_enable'] == 1){
                //validate phone number
                this.validatePhoneNumber()
                isSubmit = false
            }
            this.setState({getCaptchaToken:true,isSubmit:isSubmit,keyCaptcha: this.state.keyCaptcha + 1});
        }else if(this.state.fields.phone_number.value && this.props.pageData.appSettings['twillio_enable'] == 1){
            //validate phone number
            this.validatePhoneNumber()
        }else{
            this.createUser();
    ...
    createUser = async () => {
        ...
        if(this.props.pageData.code){
            querystring.append("code",this.props.pageData.code);
        }
    ...
    setToken = (token) => {
        if(this.state.firstToken){
            ...
            this.setState({captchaToken:token,getCaptchaToken:false},() => {
                if(this.state.fields.phone_number.value && this.props.pageData.appSettings['twillio_enable'] == 1){}else{
                    this.createUser();
                }
            });
        }
            ...
            <React.Fragment>
                ...
                <div className="form loginBox signup-form">
                    <form onSubmit={e => { this.onSubmit(e); }}>
                        ...
                        <div className="row">
                            <div className={`col-sm-${this.props.pageData.appSettings['signup_form_lastname'] == 1 ? "6" : "12"}`}>
                                <div className="form-group">
                            ...
                            {
                                this.props.pageData.appSettings['signup_form_lastname'] == 1 ? 
                        ...
                        {
                            this.props.pageData.appSettings['signup_phone_number'] == 1 && this.props.pageData.appSettings['twillio_enable'] == 1 ?
                        <div className="row">
                            <div className="col-sm-12">
                                <div className="form-group">
                                <PhoneInput
                        ...
                        {
                            this.props.pageData.appSettings['signup_form_username'] == 1 ?  
                        <div className="row">
                            <div className="col-sm-12">
                                <div className="form-group">
                        ...
                        {
                            this.props.pageData.appSettings['signup_form_timezone'] == 1 ?  
                        <div className="row">
                            <div className="col-sm-6">
                                <div className="form-group">
                        ...
                        {
                            this.props.pageData.appSettings['signup_form_gender'] == 1 ?  
                        ...
                        {
                            this.props.pageData.appSettings['signup_form_image'] == 1 ?  
                        <div className="row">
                            <div className="col-sm-12">
                            ...
                            </div>
                            {
                                ...
                                <div className="col-sm-12">
                                    <input className="form-control" type="file" id="signup_file" accept="image/*" onChange={e => { this.onChange(e, "file"); }} />
                        ...
                        {
                            this.props.pageData.appSettings['enable_newsletter'] != 2 ?
                        <div className="row">
                            <div className="col-sm-12">
                                <div className="form-group">
                            ...
                            <div className="col-sm-12">
                                <div className="form-group">
		                            ...
		                            {Translate(this.props,'By creating your account, you agree to our ')}
                                        <Link href="/terms">
                                            <a onClick={this.forgot}>{Translate(this.props,'Terms of Service')}</a> 
                                        </Link>
                                        {" & "} <Link href="/privacy"><a onClick={this.forgot}>{Translate(this.props,'Privacy Policy')}</a></Link>
                                    </label>
                                    {
                ...
                <div className="forgot">
                    {
                        this.props.router.pathname == "/login" || this.props.router.pathname == "/signup"  ?
                            ...
                            :
                            <a href="/login" id="loginbtn" data-bs-dismiss="modal" data-bs-target="#loginpop" data-bs-toggle="modal">{Translate(this.props, "Already have an account login?")}</a>
                    }
                    <Link href="/forgot">
                        <a className="forgot-btn-signup" onClick={this.forgot}>{Translate(this.props, "forgot password?")}</a>
                    </Link>
                </div>
            </React.Fragment>
        )
